...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Methods.arrayFill(random, firstFactor, "firstFactor", minValue, maxValue);
        Methods.arrayFill(random, secondFactor, "secondFactor", minValue, maxValue);
        Methods.multiplArrays(firstFactor, secondFactor, firstSize, secondSize);
    }
}
